...
carloancalculator_CarLoanCalculator.__meta__ = _hx_AnonObject({'obj': _hx_AnonObject({'SuppressWarnings': [["checkstyle:FieldDocComment", "checkstyle:LocalVariableName", "checkstyle:MultipleStringLiterals", "checkstyle:MagicNumber"]]})})
